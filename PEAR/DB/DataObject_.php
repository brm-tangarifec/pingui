...
define('DB_DATAOBJECT_ENUM', 512); // is blob type
define('DB_DATAOBJECT_EMAIL', 1024); // is blob type
define('DB_DATAOBJECT_PASSWORD', 2048); // is blob type
define('DB_DATAOBJECT_RADIO', 4096); // is blob type
define('DB_DATAOBJECT_CHECK', 8192); // is blob type
define('DB_DATAOBJECT_SELECT', 16384); // is blob type
define('DB_DATAOBJECT_1_TO_N', 32768); // is blob type
define('DB_DATAOBJECT_N_TO_M', 65536); // is blob type
define('DB_DATAOBJECT_FILE', 131072); // is blob type
define('DB_DATAOBJECT_HIDDEN', 262144); // is blob type
define('DB_DATAOBJECT_NOSHOW', 524288); // is blob type
//define('DB_DATAOBJECT_AUTOINCREMENT', 262144); // is blob type
...
class DB_DataObject extends DB_DataObject_Overload
{
    ...
    */
	...
	/**
	 * find results and store all elements in an array
	 * of objects, in the query.
	 * 
	 * @access public
	 * @return mixed Return an array of objects
	 */
	function getAll()
	{
		$n = $this->find();
		$objects = $this->getAllRows();
...
//			printVar($this);exit();
			$this->getLinks();
			$obj = serialize($this);
			// Not use clone because this cause mising bugs with PHP version 5 or 4
    ...
    /**
     * Insert or Update an object if this exists
     * in the table uses keys and 
     * uses the keys() to decide how to update
     * Returns the  true on success
     *
     * for example
